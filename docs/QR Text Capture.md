...
O **QR Text Capture** é uma aplicação web genérica para ler o texto de QR Codes presentes em imagens e manter um histórico por usuário. O projeto não possui regras de negócio específicas de eleições ou de qualquer outro domínio.
